...
export default function ViewMaterial() {
  ...
  useEffect(() => {
    axios.post(`${import.meta.env.VITE_API_BASE_URL}/material/view`, {   //API CALL
      ...
      .then((result) => {
        if (result.data._status == true) {           //BACKEND M CHECK KAREGA KI STATUS TRUE
          ...
          setMaterial([]);                      //STATUS FALSE HOGA TO ESME JAYGA
          iziToast.error({
            title: 'error',
        ...
        buttons: [
          [
            ...
            function (instance, toast) {
              axios.post('http://localhost:5000/api/admin/material/delete', {
                id : selectedRecord,
              })
                .then((result) => {
                  if (result.data._status == true) {
      ...
      <section className="w-full">
        ...
        <nav className="flex border-b bg-white px-6 py-3 shadow-sm">
          <ol className="inline-flex items-center space-x-2 text-gray-600">
            <li>
              <a className="text-md font-medium hover:text-violet-600">Home</a>
            </li>
            <li>/</li>
            <li>
              <a className="text-md font-medium hover:text-violet-600">Material</a>
            </li>
            <li>/</li>
        ...
        <div className="p-4">
          ...
          <div className="bg-orange-500 flex justify-between items-center py-3 px-4 rounded-t-md border border-slate-300">
                ...
                <thead className="text-sm uppercase bg-gray-50 border-b">
                  <tr>
                    <th className="px-2 w-[100px] py-3">
                      <input type="checkbox" checked={Material.length == selectedRecord.length ? 'checked' : ''}
