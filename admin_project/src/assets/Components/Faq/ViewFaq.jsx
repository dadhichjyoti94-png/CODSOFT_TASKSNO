...
export default function ViewFaq() {
  ...
  useEffect(() => {
    axios.post(`${import.meta.env.VITE_API_BASE_URL}/faq/view`, {
  ...
  const selectAllCheckBox = () => {
    if (faq.length == selectedRecord.length) {
      setSelectedRecord([]);
    }
    else {
      setSelectedRecord([]);
  ...
  const changeStatus = () => {
    ...
    if (selectedRecord.length > 0) {
      ...
      axios.put(`${import.meta.env.VITE_API_BASE_URL}/faq/change-status`, {
        ids: selectedRecord
        ...
        buttons: [
          ...
          [
            ...
            function (instance, toast) {
              ...
              axios.post(`${import.meta.env.VITE_API_BASE_URL}/faq/delete`, {
                id: selectedRecord

              })
                .then((result) => {
                  if (result.data._status == true) {
                    const remainingFaq = faq.filter((item) => !selectedRecord.includes(item._id));
                    setFaq(remainingFaq);
                    setApiStatus(!apiStatus)
                    iziToast.success({
                      title: "Record Delete",
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-white border-b px-6 py-4">
          ...
          <p className="text-2xl font-semibold text-gray-800">
            Home | Faq |{" "}
            <span className="text-violet-500">View Faq</span>
          </p>
                  ...
                  <tr>
                    ...
                    <th className="px-2 w-[100px] py-3">
                      ...
                      <input
                        ...
                        id="purple-checkbox"
                        type="checkbox"
                        checked = {faq.length == selectedRecord.length ? 'checked' : ''}
                    ...
                    <th className="px-2 w-[120px] py-3"> Question </th>
